...
if (function(e) {
        ...
        s.waypoint({
            ...
            e("#header-search").hasClass("is-visible") || (jQuery(window).scrollTop() >= 300 ? jQuery("#hubspot-messages-iframe-container").fadeIn(400) : jQuery(".calendly-badge-content").fadeOut(400))
        })
